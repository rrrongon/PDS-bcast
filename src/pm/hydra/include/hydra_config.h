...
/* Define to 1 if you have the `pbs' library (-lpbs). */
/* #undef HAVE_LIBPBS */
...
/* Define if PBS Pro support is enabled */
/* #undef HAVE_PBS_PRO */
...
/* Configure arguments */
#define HYDRA_CONFIGURE_ARGS_CLEAN "'--disable-option-checking' '--prefix=/home/rongon/research/mpi/mvapich/mvapich2_install' '--cache-file=/dev/null' '--srcdir=.' 'CC=gcc' 'CFLAGS= -DNDEBUG -DNVALGRIND -O2' 'LDFLAGS=' 'LIBS=-lrt -ldl -lm -lpthread ' 'CPPFLAGS= -I/home/rongon/research/mpi/mvapich/mvapich2-2.3.7/src/mpl/include -I/home/rongon/research/mpi/mvapich/mvapich2-2.3.7/src/mpl/include -I/home/rongon/research/mpi/mvapich/mvapich2-2.3.7/src/openpa/src -I/home/rongon/research/mpi/mvapich/mvapich2-2.3.7/src/openpa/src -D_REENTRANT -I/home/rongon/research/mpi/mvapich/mvapich2-2.3.7/src/mpi/romio/include' 'MPLLIBNAME=mpl'"
