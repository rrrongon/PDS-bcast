...
/* Define to 1 if you have the declaration of `IBV_QPT_XRC', and to 0 if you
   don't. */
#define HAVE_DECL_IBV_QPT_XRC 0

/* Define to 1 if you have the declaration of `IBV_WC_DRIVER1', and to 0 if
   you don't. */
#define HAVE_DECL_IBV_WC_DRIVER1 0

/* Define to 1 if you have the declaration of `IBV_WC_DRIVER2', and to 0 if
   you don't. */
#define HAVE_DECL_IBV_WC_DRIVER2 0
...
#define HAVE_PMI2_SHMEM_IALLGATHER 1

/* Define if pmi client supports PMI2_SHMEM_Iallgather_wait */
#define HAVE_PMI2_SHMEM_IALLGATHER_WAIT 1
...
/* Define if using hydra pmi client */
#define HYDRA_PMI_CLIENT 1
...
#define PACKAGE_STRING "MVAPICH2 2.3.7"
...
/* Define to enable profiling of job startup code */
/* #undef PROFILE_STARTUP */
...
/* Define to enable support for hot spot avoidance. */
/* #undef _ENABLE_HSAM_ */

/* Define to enable abstraction of calls to IB Verbs */
#define _ENABLE_IBV_DLOPEN_ 1

/* Define to enable hybrid design. */
#define _ENABLE_UD_ 1

/* Define to enable support for IBV_WC_DRIVER1 */
/* #undef _ENABLE_WC_DRV1_ */

/* Define to enable support for IBV_WC_DRIVER2 */
/* #undef _ENABLE_WC_DRV2_ */
...
/* Define to check for max_dm_size. */
/* #undef _IBV_DEVICE_ATTR_EX_HAS_MAX_DM_SIZE_ */
...
/* Define when using HWLOC V1 */
#define _USE_HWLOC_V1_ 1

/* Define when using HWLOC V2 */
/* #undef _USE_HWLOC_V2_ */
